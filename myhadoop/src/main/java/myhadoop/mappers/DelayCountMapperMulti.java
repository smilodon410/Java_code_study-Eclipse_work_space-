...
public class DelayCountMapperMulti extends Mapper<LongWritable, Text, Text, IntWritable>{
	// 출력 값, 키
	...
	protected void map(LongWritable key, Text value, Context context)
		...
		// 출력 1: D,년,월 -> 리듀서에서 출발 지연 MultipleOutputs로 출력
		// 출력 2: A,년,월 -> 리듀서에서 도착 지연 MultipleOutputs로 출력
	}
